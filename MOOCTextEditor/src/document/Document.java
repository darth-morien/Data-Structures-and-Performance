...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		int syllablesNumberInEWord=0;
		int vowelsNumberInEWord=0;
		...
		//	if (isELastChar(word)) {
				if (isNotVowel(word, i)) {
					...
					} else if (isVowel(word, i)&& newSyllable){
						syllablesNumberInEWord++;
						vowelsNumberInEWord++;
						newSyllable = false;
					
					} else if ( (i==word.length()-1) && (isVowel(word, i)) ){
						vowelsNumberInEWord++;
						syllablesNumberInEWord++;
		...
		if (vowelsNumberInEWord==1) {
			return syllablesNumberInEWord;
		} else if (vowelsNumberInEWord>1) {
			return syllablesNumberInEWord-1;
		} else{
	...
	protected boolean isVowel(String word,int i){
		return word.charAt(i)=='a'||word.charAt(i)=='e'||word.charAt(i)=='y'||word.charAt(i)=='i'
						||word.charAt(i)=='u'||word.charAt(i)=='o'||word.charAt(i)=='A'||
								word.charAt(i)=='E'||word.charAt(i)=='I'||word.charAt(i)=='O'||
								word.charAt(i)=='U';
		
	}
	
	protected boolean isNotVowel(String word,int i){
		return !(word.charAt(i)=='a'||word.charAt(i)=='e'||word.charAt(i)=='y'||word.charAt(i)=='i'
						||word.charAt(i)=='u'||word.charAt(i)=='o'||word.charAt(i)=='A'||
								word.charAt(i)=='E'||word.charAt(i)=='I'||word.charAt(i)=='O'||
								word.charAt(i)=='U');
...
/*	protected boolean isELastChar(String word){
		char[] cArray = word.toCharArray();
		return Character.toLowerCase(cArray[cArray.length-1]) == 'e';
	...
	public double getFleschScore()
	{
		...
		double fleschScoreRounded = Math.round(fleschScore*10.0)/10.0;

		return fleschScoreRounded;
